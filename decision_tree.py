...
y_cols = ['Machine failure', 'TWF', 'HDF', 'PWF', 'OSF']
...
train_acc2 = round(dt.score(X_train, y_train) * 100, 1)
...
# final=[np.array(inputt)]
# b = svc.predict(final)
rfcFile = open('DecisionTreeModel.pkl', 'wb')
pickle.dump(dt, rfcFile)
rfcFile.close()
