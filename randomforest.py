...
df['Type'].replace(['L', 'M', 'H'], [1, 2, 3], inplace=True)
...
random_forest_train = round(random_forest.score(X_train2, y_train2) * 100, 2)
random_forest_accuracy = round(accuracy_score(y_pred_rf, y_test2) * 100, 2)

svmFile = open('RandomForest.pkl', 'wb')
pickle.dump(random_forest, svmFile)
svmFile.close()
