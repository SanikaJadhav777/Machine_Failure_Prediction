...
y_hat_train1 = logreg.predict(X_train2)
evaluate(y_train2, y_hat_train1, 'train')

y_hat_test1 = logreg.predict(X_test2)
evaluate(y_test2, y_hat_test1)

train_acc2 = round(logreg.score(X_train2, y_train2) * 100, 1)
...
svmFile = open('LRModel.pkl', 'wb')
pickle.dump(logreg, svmFile)
svmFile.close()
